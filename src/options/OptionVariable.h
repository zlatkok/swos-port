...
static void loadOptions(const CSimpleIniA& ini, const std::array<OptionVariable<T>, N>& options, const char *section)
{
...
template<typename T, size_t N>
inline void saveOptions(CSimpleIni& ini, const std::array<OptionVariable<T>, N>& options, const char *section)
{
    for (const auto& opt : options)
