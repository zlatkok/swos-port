...
void VmFileWriter::outputHeaderFile()
{
    constexpr char kVmHeaderContentsPart1[] =
        ...
        "//    |   safe area   |\n"
        "//    +---------------+\n"
        "//    |  extended mem |    (memory allocated from the OS)\n"
        "//    +---------------+\n"
        "//    |   safe area   |\n"
        "//    +---------------+\n"
        "//    | pointer pool  |    (native pointers, pointing outside SWOS VM)\n"
        "//    |     area      |\n"
        "//    +---------------+\n"
        "//    |   safe area   |\n"
        "//    +---------------+\n"
        "//    |  dynamic mem  |    (memory allocated by code outside SWOS VM)\n"
        "//    |  (allocated)  |\n"
        "//    +---------------+\n"
        "//    |   safe area   |\n"
        "//    +---------------+\n";
    ...
    constexpr char kVmHeaderContentsPart2[] = "\n"
        ...
        "using MemoryMark = std::tuple<dword, dword, dword>;\n"
        ...
        "static inline bool isExternalPointer(dword addr) { return true; }\n"
        "#endif\n\n"
...
void VmFileWriter::outputMemoryAccessFunctions()
{
    const char kMemFunctions[] = "\n"
        ...
        "    return { memMark, pointerMark, procMark };\n"
        "}\n"
        "\n"
        "void releaseAllMemory(const MemoryMark& mark)\n"
        "{\n"
...
void VmFileWriter::outputDebugFunctions()
{
    const char kFunctions[] =
        ...
        "        assert(area[i] == std::array<char, 3>{ 'z', 'k', 'z' } [i % 3]);\n"
        "}\n"
        "\n"
        "void verifySafeMemoryAreas()\n"
        "{\n"
